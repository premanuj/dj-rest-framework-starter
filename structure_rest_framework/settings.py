"""
Django settings for structure_rest_framework project.
...
ROOT_URLCONF = "structure_rest_framework.urls"
...
WSGI_APPLICATION = "structure_rest_framework.wsgi.application"
...
LOGGING = {
    ...
    "loggers": {
        "apps": {"level": "DEBUG"},
        "structure_rest_framework": {"level": "DEBUG"},
        "libs": {"level": "DEBUG"},
        "django": {"level": "INFO"},
